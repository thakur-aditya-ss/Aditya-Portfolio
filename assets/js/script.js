$(document).ready(function () {
    ...
    // <!-- FormSubmit AJAX to mail contact form data -->
    $("#contact-form").submit(function (event) {
        ...
        fetch("https://formsubmit.co/ajax/aaasingh1010@gmail.com", {
            ...
            .then(data => {
                ...
                alert("Success! Your message has been sent to Aditya.");
                // Re-enable button
                $("#contact-form").find('button[type="submit"]').text('Submit').prop('disabled', false);
            })
            .catch(error => {
                console.log(error);
                alert("Something went wrong. Please try again or email directly at aaasingh1010@gmail.com");
                $("#contact-form").find('button[type="submit"]').text('Submit').prop('disabled', false);
            });
    });
    // <!-- FormSubmit AJAX to mail contact form data -->
...
var typed = new Typed(".typing-text", {
    strings: ["frontend developer", "backend developer", "", "Java full stack developer", "web developer"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
